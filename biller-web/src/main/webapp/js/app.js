...
billerModule.config([ '$routeProvider', function($routeProvider, $rootScope, $location) {
	...
	}).when('/costcenters', { templateUrl : 'html/costcenter-list.html', controller : 'CostCenterListCtrl'
	}).when('/costcenters/id/:id', { templateUrl : 'html/costcenter-detail.html', controller : 'CostCenterDetailCtrl'
	...
	}).when('/models', { templateUrl : 'html/model-list.html', controller : 'ModelListCtrl'
	}).when('/models/id/:id', { templateUrl : 'html/model-detail.html', controller : 'ModelDetailCtrl'
	}).when('/models/new', { templateUrl : 'html/model-detail.html', controller : 'ModelNewCtrl'
